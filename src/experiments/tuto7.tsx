...
import { vertex_shader_2d_300es_rotation_scaleFix } from '../shaders/vertex_shader_2d_300es_rotation_scaleFix';
...
function setupWebGL(gl: WebGL2RenderingContext, pointerParams: PointerParams): WebGLStuff {
  ...
  var vertexShaderSource = vertex_shader_2d_300es_rotation_scaleFix;
  ...
  var color = [Math.random(), Math.random(), Math.random(), .75];
...
export default class Tuto7 extends React.Component<Props, State> {
