...
import { fragment_shader_2d } from '../shaders/fragment_shader_2d';
import { vertex_shader_2d } from '../shaders/vertex_shader_2d';
...
function main() {
  ...
  var vertexShaderSource = vertex_shader_2d;
  var fragmentShaderSource = fragment_shader_2d;
...
export default class Tuto1 extends React.Component {
	render (): JSX.Element {
